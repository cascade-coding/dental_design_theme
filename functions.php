...
require_once get_template_directory() . '/inc/services/custom-category-features.php';

require_once get_template_directory() . '/inc/services/register-custom-blocks.php';
